  ...
  return (
    <div>
      <div className="w-full lg:max-w-6xl h-full lg:h-160 overflow-y-auto bg-sky-500/10 backdrop-blur-lg shadow-2xl rounded-3xl p-6 border border-white/40">
        ...
        <h2 className="text-2xl font-bold mb-6 bg-linear-to-r from-blue-900 to-purple-900 bg-clip-text text-transparent flex items-center gap-2">
          <CreditCard className="text-blue-500" size={26} />
          <span className="pb-1">Payment History</span>
        </h2>
          ...
          <table className="w-full text-center border-separate border-spacing-y-3">
            ...
            <thead>
              <tr className="bg-linear-to-r from-blue-600 to-purple-600 text-white">
                <th className="py-4 rounded-l-xl uppercase">Email</th>
                <th className="py-4 uppercase">Amount</th>
                <th className="py-4 uppercase">Transaction ID</th>
                <th className="py-4 uppercase rounded-r-xl">Paid At</th>
              </tr>
            </thead>
